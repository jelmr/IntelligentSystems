...
public class CustomBot {
	...
	private static Planet getTargetPlanet(PlanetWars pw) {
		List<Planet> notMyPlanets = pw.Planets();
	...
	private static double calculateSourceScore(Planet source) {
		return source.NumShips();
	}


	private static double calculateTargetScore(Planet target) {
