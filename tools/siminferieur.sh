...
#for map in ${maps[*]}
for map in C:/Users/Yoran/Documents/GitHub/IntelligentSystems/tools/maps/**/*.txt
do
    # Keep track of wins
    player1=0
    player2=0
    ...
    while [  $COUNTER -lt $SIMULATIONS ]; do
        echo Game $COUNTER
        output=$(java -jar C:\\Users\\Yoran\\Documents\\GitHub\\IntelligentSystems\\tools\\PlayGame.jar $map  "java $PLAYER1 " "java $PLAYER2" parallel $NTURN $MAXT 2>&1 )
